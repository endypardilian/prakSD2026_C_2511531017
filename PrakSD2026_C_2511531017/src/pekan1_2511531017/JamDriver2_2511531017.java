...
public class JamDriver2_2511531017 {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n--- Input Jam 1 ---");
		Jam_2511531017 j1 = buatJamDariInput(input);
		
		System.out.println("\n--- Input Jam 2 ---");
		Jam_2511531017 j2 = buatJamDariInput(input);
		...
		if (perbandingan > 0) {
			...
			System.out.println("Status               : Jam 1 dan Jam 2 saam persis");
		}
		System.out.println("Durasi (J1 ke J2)        :" + Jam_2511531017.durasiDetik(j1,j2) + " detik");
		
		Jam_2511531017 jNext = j1.nextSecond();
		System.out.println("Jam 1 Detik Berikutnya   :" + jNext);
		
		Jam_2511531017 jPrev =j1.prevSecond();
		System.out.println("Jam 1 Detik Sebelumnya   :" + jPrev);
		
		Jam_2511531017 jHasilPlus = j1.plus(j2);
	...
	private static Jam_2511531017 buatJamDariInput (Scanner sc) {
		int h,m,s;
		while (true) {
			...
			if (Jam_2511531017.isValid(h,m,s)) {
